...
- **禁止主动生成文档** — AI Agent **不得**主动创建 `*.md` 或其他文档文件
- **仅按明确要求创建** — 只有当用户明确要求时，才能创建文档
- **代码注释优先** — 用 Docstring 和代码注释代替文档
- **最小化原则** — 代码即文档，避免冗余说明
...
1. 用户明确说："请写 xxx.md 文档"
2. 用户明确说："包含文档" 或 "需要文档说明"
3. AGENTS.md 本文件明确要求（如本节本身）
4. 项目配置文件明确要求（如 pyproject.toml）
